...
const CORE_FUNCTIONS = [
  ...
  { fn: "USD Treasuries Acc", why: "A ladder of US Treasury securities by duration.", tickers: ["IB01", "IBTA", "CBU7", "IB7A", "DTLA"], note: "From yield-bearing cash to a directional position on lower rates." },
  { fn: "USD inflation Acc", why: "TIPS with different duration profiles.", tickers: ["TI5A", "IDTP"], note: "Separates short inflation protection from broad inflation exposure." },
...
const FIXED_INCOME_TICKERS = new Set(["IB01", "IBTA", "CBU7", "IB7A", "DTLA", "TI5A", "IDTP", "LQDA", "IHYA", "AGGU"]);
...
const coreTokenClass = (ticker, vehicleView) => {
  ...
  if (vehicleView !== "all") {
    classes.push(tickerMatchesVehicleView(ticker, vehicleView) ? "is-ucits-highlight" : "is-muted");
  }
  return classes.join(" ");
};
          ...
          ? React.createElement(
              ...
              React.createElement(
                ...
                showVehicleToggle
                  ? React.createElement(
                      "div",
                      { className: "ucits-toggle", "aria-label": "Highlight ETFs by listing type" },
...
function FixedIncomeModule({ dataLabTickers, initialEtf = "IB01" }) {
  return React.createElement(CoreModule, { functions: FIXED_INCOME_FUNCTIONS, initialEtf, legendMode: "fixed", showVehicleToggle: false, dataLabTickers });
}
